  ...
  styles: [`
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .hero-eyebrow {
      ...
      border-radius: 20px; border: 1px solid rgba(165,243,252,0.2); margin-bottom: 1rem;
    }
    .hero-title { font-family: 'Poppins', sans-serif; font-size: 2rem; font-weight: 900; color: white; letter-spacing: -0.5px; line-height: 1.2; margin-bottom: 0.6rem; }
    .hero-name { background: linear-gradient(90deg, #a78bfa, #67e8f9); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; }
    .wave { -webkit-text-fill-color: initial; }
    .hero-sub { font-family: 'Inter', sans-serif; color: #c4b5fd; font-size: 0.92rem; margin-bottom: 1.4rem; }
    ...
    .hero-card-float { background: rgba(255,255,255,0.1); backdrop-filter: blur(16px); border: 1px solid rgba(255,255,255,0.18); border-radius: 16px; padding: 1rem 1.4rem; display: flex; align-items: center; gap: 0.9rem; min-width: 220px; }
    .hcf-icon { width: 42px; height: 42px; border-radius: 12px; background: linear-gradient(135deg, #4f46e5, #7c3aed); display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
    ...
    .table-card-header { display: flex; justify-content: space-between; align-items: center; padding: 1.2rem 1.5rem; border-bottom: 1px solid #f1f5f9; background: #fafbff; }
    ...
    .table-card-header h2 { font-family: 'Poppins', sans-serif; font-size: 0.95rem; font-weight: 700; color: #0f172a; }
    .view-all-btn { display: inline-flex; align-items: center; gap: 0.3rem; background: #f0f4ff; color: #4f46e5; padding: 0.35rem 0.9rem; border-radius: 20px; text-decoration: none; font-family: 'DM Sans', sans-serif; font-size: 0.78rem; font-weight: 600; transition: background 0.2s; }
    .view-all-btn:hover { background: #e0e7ff; }
    .table-list { padding: 0.5rem 0; }
    .table-item { display: flex; align-items: center; gap: 0.9rem; padding: 0.85rem 1.5rem; border-bottom: 1px solid #f8fafc; transition: background 0.15s; animation: slideIn 0.4s ease both; }
    .table-item:last-child { border-bottom: none; }
    .table-item:hover { background: #fafbff; }
    @keyframes slideIn { from { opacity:0; transform: translateY(8px); } to { opacity:1; transform: translateY(0); } }
    .ti-rank { width: 22px; height: 22px; border-radius: 6px; background: #f1f5f9; color: #94a3b8; font-family: 'Space Grotesk', sans-serif; font-size: 0.72rem; font-weight: 700; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
    .ti-icon { width: 34px; height: 34px; border-radius: 10px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
    ...
    /* ── Empty ── */
    .empty-state { text-align: center; padding: 4rem 2rem; background: white; border-radius: 24px; box-shadow: 0 2px 12px rgba(0,0,0,0.06); position: relative; overflow: hidden; }
    .empty-glow { position: absolute; width: 300px; height: 300px; border-radius: 50%; background: radial-gradient(circle, rgba(99,102,241,0.1), transparent 70%); top: 50%; left: 50%; transform: translate(-50%,-50%); }
    .empty-icon-wrap { width: 80px; height: 80px; border-radius: 24px; background: linear-gradient(135deg, #4f46e5, #7c3aed); display: flex; align-items: center; justify-content: center; margin: 0 auto 1.5rem; box-shadow: 0 12px 30px rgba(79,70,229,0.35); position: relative; z-index: 1; }
    ...
    .empty-btn { display: inline-flex; align-items: center; gap: 0.5rem; background: linear-gradient(135deg, #4f46e5, #7c3aed); color: white; padding: 0.8rem 1.8rem; border-radius: 12px; text-decoration: none; font-family: 'DM Sans', sans-serif; font-size: 0.9rem; font-weight: 600; box-shadow: 0 6px 18px rgba(79,70,229,0.35); transition: transform 0.2s; position: relative; z-index: 1; }
